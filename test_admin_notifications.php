...
/**
 * BAKEHUB ADMIN NOTIFICATION TESTING SCRIPT
 * 
...
$result2 = $firebaseService->sendToTokens(
    [$fcmToken],
    "👩‍🍳 Order in Kitchen!",
...
$result6 = $firebaseService->sendToTokens(
    [$fcmToken],
    "✅ Design Approved!",
...
$result7 = $firebaseService->sendToTokens(
    [$fcmToken],
    "💰 Price Quote Ready!",
...
$result8 = $firebaseService->sendToTokens(
    [$fcmToken],
    "📦 Bulk Order Received!",
...
$result9 = $firebaseService->sendToTokens(
    [$fcmToken],
...
$result10 = $firebaseService->sendToTopic(
    'promotions',
...
$result11 = $firebaseService->sendToTopic(
    'promotions',
    "🎉 Special Offer Alert!",
...
$result12 = $firebaseService->sendToTopic(
    'promotions',
    "🎊 Eid Mubarak Special!",
...
$result13 = $firebaseService->sendToTokens(
    [$fcmToken],
...
$result14 = $firebaseService->sendToTokens(
    [$fcmToken],
...
$result15 = $firebaseService->sendToTokens(
    [$fcmToken],
    "🍰 We Miss You, Ahmed!",
...
$result16 = $firebaseService->sendToTokens(
    [$fcmToken],
    "⚠️ Low Stock Alert",
...
$result17 = $firebaseService->sendToTokens(
    [$fcmToken],
    "🔔 New Order Received",
...
if ($successCount === 17) {
    ...
    echo "========================\n";
    echo "1. 📋 Use order management APIs to update order status\n";
    echo "2. 🎂 Manage custom cake requests and send quotes\n";
    echo "3. 📦 Handle bulk orders with pricing\n";
    echo "4. 🎉 Send promotional campaigns to all users\n";
    echo "5. ⚠️ Monitor stock levels and get alerts\n";
    echo "6. 🔔 Receive instant alerts for new orders\n\n";
